...
#[reflect(Resource)] // FORK: In order to show up in bevy-inspector-egui WorldInspector
pub struct ConsoleConfiguration {
    ...
    #[reflect(ignore)] // FORK: In order to show up in bevy-inspector-egui WorldInspector
